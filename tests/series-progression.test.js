...
assert.ok(html.includes('class="actor-award hope"'));
assert.ok(html.includes('class="actor-award monokuma"'));
assert.ok(html.includes("HOPE_PEAK_AWARD_ICON"));
assert.ok(html.includes("MONOKUMA_AWARD_ICON"));
...
assert.ok(html.includes('sharedStateVersion<13'));
assert.ok(sql.includes("'dr1', 'dr2', 'dr3anime', 'v3'"));
assert.ok(html.includes("version:13"));
