...
assert.deepEqual(versions, ["v0.15", "v0.14", "v0.13", "v0.12", "v0.11", "v0.10", "v0.9", "v0.8.1", "v0.8", "v0.7", "v0.6", "v0.5"]);
assert.equal((html.match(/<details class="patch-release"/g) || []).length, 12);
